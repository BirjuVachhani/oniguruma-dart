// Build hook for the `package:oniguruma_native/oniguruma_native` code asset that the
...
String? _prebuiltRelPath(BuildInput input, OS os, Architecture arch) {
  ...
  return '$platformDir/${os.dylibFileName('oniguruma_native')}';
}
